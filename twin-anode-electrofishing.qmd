...
Although the theory for population estimation by depletion electrofishing applies equally to sampling by single and twin anodes, the assumptions can differ leading to different population estimates.
...
2.    Here, I using a series of simple simulation experiments to show that common reasons for deciding whether to use a single or twin anode sampling strategy will result in different population estimates precisely for the reasons on which those decisions are based.
